  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "after:absolute after:inset-x-0 after:bottom-0 after:h-0.5 after:bg-primary after:scale-x-0 after:transition-transform data-[state=active]:after:scale-x-100",
