...
import LazyPdfPreview from '@/components/lazy-pdf-preview';
...
export default function IdeaCreate({ thematicAreas, currentUser }: { thematicAreas: any[]; currentUser: CurrentUser }) {
  ...
  const [, setIpDocument] = useState<File | null>(null);
            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
              ...
              <div className="grid gap-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Declare any personal, professional, or financial interests that may conflict with this idea.
                  By submitting this idea, you indemnify KeNHA against any intellectual property disputes.
                </p>
              ...
              {data.collaboration_enabled && (
                <div className="ml-6 grid gap-2">
                  <Label htmlFor="ip_document">IP Protection Document (optional)</Label>
                  <Input
                    id="ip_document"
                    type="file"
                    accept=".pdf,.txt"
                    onChange={(e) => {
                      ...
                      setIpDocument(file || null);
                    }}
                  />
                  <p className="text-sm text-muted-foreground">Upload a patent, trademark, or copyright document to protect your intellectual property.</p>
                </div>
              )}
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    setAttachmentPreview(file || null);
                  }}
                />
              ...
              {attachmentPreview && (
                <LazyPdfPreview file={attachmentPreview} />
              )}
