...
export default function IdeaClassificationEdit({ ideaClassification }: Props) {
    ...
    return (
        <>
            <Head title="Edit Idea Classification" />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <Heading
                        title="Edit Idea Classification"
                        description={`Update "${ideaClassification.name}"`}
                    />
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Form
                            method="put"
                            action={`/idea-classifications/${ideaClassification.id}`}
                            className="space-y-6"
                            ref={formRef}
                            onSubmit={(e) => {
                                setClientErrors({});
                                    ...
                                    <>
                                        <div className="grid gap-2">
                                            ...
                                            <Input
                                                id="name"
                                                name="name"
                                                defaultValue={ideaClassification.name}
                                            />
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <Textarea
                                                id="description"
                                                name="description"
                                                defaultValue={ideaClassification.description ?? ''}
                                            />
