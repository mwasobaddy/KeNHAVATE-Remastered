...
export default function IdeaCategoryEdit({ ideaCategory }: Props) {
        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <Heading
                        title="Edit Idea Category"
                        description={`Update "${ideaCategory.name}"`}
                    />
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Form
                            method="put"
                            action={`/idea-categories/${ideaCategory.id}`}
                            className="space-y-6"
                            ref={formRef}
                            onSubmit={(e) => {
                                setClientErrors({});
                                    ...
                                    <>
                                        <div className="grid gap-2">
                                            ...
                                            <Input
                                                id="name"
                                                name="name"
                                                defaultValue={ideaCategory.name}
                                            />
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <Textarea
                                                id="description"
                                                name="description"
                                                defaultValue={ideaCategory.description ?? ''}
                                            />
                                        ...
                                        <div className="flex items-center space-x-3">
                                            <input
                                                ...
                                                type="checkbox"
                                                value="1"
                                                defaultChecked={ideaCategory.is_active}
