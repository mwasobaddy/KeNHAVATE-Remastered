...
export default function DirectorateEdit({ directorate, regions }: Props) {
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <Heading
                        ...
                        description={`Update "${directorate.name}"`}
                    />
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Form
                            method="put"
                            action={`/directorates/${directorate.id}`}
                            className="space-y-6"
                            ref={formRef}
                            onSubmit={(e) => {
                                setClientErrors({});
                                    ...
                                    <>
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <Textarea
                                                id="description"
                                                name="description"
                                                defaultValue={directorate.description ?? ''}
                                            />
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <Select name="region_id" defaultValue={directorate.region_id?.toString() ?? ''}>
                                                <SelectTrigger>
                                        ...
                                        <div className="flex items-center space-x-3">
                                            <input
                                                ...
                                                type="checkbox"
                                                value="1"
                                                defaultChecked={directorate.is_active}
