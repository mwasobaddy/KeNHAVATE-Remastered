...
export default function ContractTypeEdit({ contractType }: Props) {
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <Heading
                        ...
                        description={`Update "${contractType.name}"`}
                    />
                </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <Form
                            method="put"
                            action={`/contract-types/${contractType.id}`}
                            className="space-y-6"
                            ref={formRef}
                            onSubmit={(e) => {
                                setClientErrors({});
