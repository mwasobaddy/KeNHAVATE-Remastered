...
export default function AuthSplitLayout({
    ...
    return (
        <div className="relative grid h-dvh flex-col items-center justify-center lg:grid-cols-2">
            ...
            <div className="relative hidden h-full flex-col bg-[#231F20] p-10 text-white lg:flex">
                ...
                <div className="relative z-20 flex flex-col justify-center h-full max-w-lg">
                    <div className="mb-8">
                        ...
                        >
                            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#F8EBD5]/10">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-lg text-[#9B9EA4]/80 leading-relaxed">
                    ...
                    <div className="absolute bottom-10 left-10 right-10">
                        <div className="relative h-32 overflow-hidden rounded-lg bg-white/5">
                            <div className="absolute -left-4 -top-4 h-20 w-20 rounded-full bg-[#FFF212]/20 blur-xl" />
                            <div className="absolute -right-4 -bottom-4 h-32 w-32 rounded-full bg-[#F8EBD5]/10 blur-xl" />
                            <div className="absolute inset-0 flex items-center justify-center">
                                <svg
                                    className="h-16 w-16 text-[#FFF212]/30"
                                    viewBox="0 0 24 24"
                                    fill="none"
                                    stroke="currentColor"
                                    strokeWidth="1"
            ...
            {/* Right Side - Form */}
            <div className="flex min-h-svh w-full flex-col items-center justify-center bg-[#F8EBD5] p-6 lg:p-8">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-8 flex flex-col items-center gap-2 lg:hidden">
                        ...
                        >
                            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#231F20]">
                                <AppLogoIcon className="size-6 fill-current text-[#FFF212]" />
                            </div>
                            <span className="text-xl font-semibold text-[#231F20]">
                                {name}
                            </span>
                        </Link>
